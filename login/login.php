         ...
         <div class="authentication-inner">
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <!-- /Logo -->
                  <h4 class="mb-2">Welcome to Perpustakaan! 👋</h4>

                  <form id="formAuthentication" class="mb-3" action="login-proses.php" method="POST">
                     <div class="mb-3">
                        <?php 
                        ...
                        <input type="text" id="username" name="username" placeholder="Enter your username"
                           ...
                           autofocus class="form-control <?= (isset($_SESSION['msg-user']))?"is-invalid":null ?>" />
                        <?php 
                     ...
                     <div class="mb-3">
                        <button class="btn btn-primary d-grid w-100" name="btn-login" type="submit">
                           Sign In
                        </button>
                     </div>
                  </form>
