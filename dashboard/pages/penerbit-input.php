            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <form action="pages/proses-penerbit/proses-penerbit-input.php" method="POST">
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-kode">Kode</label>
                                <div class="col-sm-10">
                                    <input name="kode" type="text" id="basic-default-kode"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="alamat" type="text" class="form-control" id="basic-default-name"
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-10">
                                    <button name="btn-submit" type="submit" class="btn btn-primary">Kirim</button>
                                </div>
                            </div>
