            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="register-proses.php" method="POST">
                            <div class="mb-3">
                                <?php 
                                ...
                                <input type="text"
                                    class="form-control <?= (isset($_SESSION['msg-name']))?"is-invalid":null ?>"
                                    id="name" name="name" placeholder="Enter your name" autofocus
                                    value="<?= (isset($_SESSION['name_cache']))?$_SESSION['name_cache']:null ?>" />
                                <?php 
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="name" name="phonenumber" placeholder="Enter your phone number"
                                    autofocus
                                    class="form-control <?= (isset($_SESSION['msg-phonenumber']))?"is-invalid":null ?>" />
                                <?php 
                                        if(isset($_SESSION['msg-phonenumber'])){
                                    ?>
                                <div id="validationServer03Feedback" class="invalid-feedback">
                                    <?= $_SESSION['msg-phonenumber'] ?>
                                </div>
                                <?php
                                        }
                                    ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="email" name="email" placeholder="Enter your email"
                                    class="form-control <?= (isset($_SESSION['msg-email']))?"is-invalid":null ?>" />
                                <?php 
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="password" id="password" name="password_confirmation"
                                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                        aria-describedby="password"
                                        class="form-control <?= (isset($_SESSION['msg-pass-conf']))?"is-invalid":null ?>" />
                                    <?php 
                            ...
                            <button type="submit" name="btn-register" class="btn btn-primary d-grid w-100">Sign
                                up</button>
                        </form>
